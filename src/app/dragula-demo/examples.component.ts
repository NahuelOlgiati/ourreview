...
@Component({
  ...
  templateUrl: './another-example.html'
})
...
@Component({
  ...
  templateUrl: './repeat-example.html'
})
...
@Component({
  ...
  templateUrl: './nested-repeat-example.html'
})
